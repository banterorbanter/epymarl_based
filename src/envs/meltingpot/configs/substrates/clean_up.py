  ...
  scene = {
      ...
      "components": [
          ...
          },
          {
              ...
              "kwargs": {
                  "dirtSpawnProbability": 0.1,  #TODO HERE TO CHANGE DIRT SPAWN PROBABILITY
...
def get_config(players:list[str]):
  ...
  config.timestep_spec = specs.timestep({
      ...
      # Global switching signals for puppeteers. (do not use the following observations in policies)
