...
import re
from envs.meltingpot.utils.utils import connected_elems_map, check_agent_out_of_game, get_element_global_pos
...
class ObservationsGenerator (object):
    ...
    def __init__(self, global_map:str, players_names: list, substrate_name:str):
        ...
        self.substrate_utils_module = import_module(f'envs.meltingpot.utilities.{substrate_name}.substrate_utils')
    ...
    def update_state_changes(self, scene_description: dict, game_time: str):
        ...
        for agent_name in self.players_names:
            ...
            observed_changes = self.get_observed_changes(local_observation_map, last_observation_map, local_map_position, global_position, last_global_position, agent_orientation, last_orientation, game_time, agent_name)
