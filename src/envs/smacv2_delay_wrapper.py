...
class SMACv2DelayWrapper(MultiAgentEnv):
    ...
    def step(self, actions):
        ...
        # else:
        #     delay = int(np.clip(np.random.normal(self.delay_mean, self.delay_std), 0, 2))
        # if self.t - delay < 0:
        #     actions = [1] * self.env.n_agents
        # else:
        #     actions = self.action_buffer[self.t - delay]
